...
<body>
    <section>
        ...
        <h2 class = "galleryHead">Jordan</h2>
        <section id = "photoStream">
        <div class = "row">
            <div class = "column">
                <img class = "scalePic" src = "../res/jordan/jordan (1).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (2).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (3).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (4).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (5).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/jordan/jordan (6).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (7).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (8).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (9).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (10).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/jordan/jordan (11).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (12).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (13).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (14).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (15).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (16).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/jordan/jordan (17).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (18).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (19).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (20).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jordan/jordan (21).jpg" width = "300px">
            </div>
	...
	<div class = "download">
        <a href = "../res/jordanZip" class = "downloadLink" download>Download these photos!</a>
    </div>
	</br>
