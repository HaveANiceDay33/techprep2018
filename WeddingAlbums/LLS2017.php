...
<html>
<head>
    <title>MVP Dance Fit Expo 2017</title>
...
<body>
    <section>
        ...
        <h2 class = "galleryHead">MVP Dance Fit Expo 2017</h2>
        <section id = "photoStream">
        <div class = "row">
            <div class = "column">
                <img src = "../res/placeholder1.png" width = "300px">
                <img src = "../res/placeholder2.png" width = "300px">
                 <img src = "../res/placeholder1.png" width = "300px">
                 <img src = "../res/placeholder2.png" width = "300px">
            </div>
             <div class = "column">
