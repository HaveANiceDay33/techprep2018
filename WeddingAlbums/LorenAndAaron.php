...
<body>
    <section>
        ...
        <h2 class = "galleryHead">Loren And Aaron</h2>
        <section id = "photoStream">
        <div class = "row">
            <div class = "column">
                <img class = "scalePic" src = "../res/loren/aaron (1).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (2).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (3).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (4).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (5).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/loren/aaron (6).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (7).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (8).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (9).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (10).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/loren/aaron (11).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (12).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (13).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (14).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (15).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (16).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/loren/aaron (17).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (18).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (19).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (20).jpg" width = "300px">
				<img class = "scalePic" src = "../res/loren/aaron (21).jpg" width = "300px">
            </div>
	...
	<div class = "download">
        <a href = "../res/lorenZip" class = "downloadLink" download>Download these photos!</a>
    </div>
	</br>
