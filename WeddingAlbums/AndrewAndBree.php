...
<body>
    <section>
        ...
        <h2 class = "galleryHead">Andrew and Bree</h2>
        <section id = "photoStream">
        <div class = "row">
            <div class = "column">
                <img class = "scalePic" src = "../res/andrew/bree (1).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (2).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (3).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (4).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (5).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/andrew/bree (6).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (7).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (8).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (9).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (10).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/andrew/bree (11).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (12).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (13).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (14).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (15).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (16).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/andrew/bree (17).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (18).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (19).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (20).jpg" width = "300px">
				<img class = "scalePic" src = "../res/andrew/bree (21).jpg" width = "300px">
            </div>
	...
	<div class = "download">
        <a href = "../res/andrewZip" class = "downloadLink" download>Download these photos!</a>
    </div>
	</br>
