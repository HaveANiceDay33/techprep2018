...
<body>
    <section>
        ...
        <h2 class = "galleryHead">Lynzie and Collin</h2>
        <section id = "photoStream">
        <div class = "row">
            <div class = "column">
                <img class = "scalePic" src = "../res/lynzie/collin (1).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (2).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (3).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (4).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (5).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/lynzie/collin (6).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (7).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (8).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (9).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (10).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/lynzie/collin (11).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (12).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (13).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (14).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (15).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (16).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/lynzie/collin (17).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (18).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (19).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (20).jpg" width = "300px">
				<img class = "scalePic" src = "../res/lynzie/collin (21).jpg" width = "300px">
            </div>
	...
	<div class = "download">
        <a href = "../res/lynzieZip" class = "downloadLink" download>Download these photos!</a>
    </div>
	</br>
