...
<body>
    ...
    <section>
        ...
        <h2 class = "galleryHead">Alyssa And Andrew</h2>
        <section id = "photoStream">
        <div class = "row">
            <div class = "column">
                <img class = "scalePic" src = "../res/alyssa/andrew (1).jpg" width = "300px">
				<img class = "scalePic" src = "../res/alyssa/andrew (2).jpg" width = "300px">
				<img class = "scalePic" src = "../res/alyssa/andrew (3).jpg" width = "300px">
				<img class = "scalePic" src = "../res/alyssa/andrew (4).jpg" width = "300px">
				<img class = "scalePic" src = "../res/alyssa/andrew (5).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/alyssa/andrew (6).jpg" width = "300px">
				<img class = "scalePic" src = "../res/alyssa/andrew (7).jpg" width = "300px">
				<img class = "scalePic" src = "../res/alyssa/andrew (8).jpg" width = "300px">
				<img class = "scalePic" src = "../res/alyssa/andrew (9).jpg" width = "300px">
				<img class = "scalePic" src = "../res/alyssa/andrew (10).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/alyssa/andrew (11).jpg" width = "300px">
				<img class = "scalePic" src = "../res/alyssa/andrew (12).jpg" width = "300px">
				<img class = "scalePic" src = "../res/alyssa/andrew (13).jpg" width = "300px">
				<img class = "scalePic" src = "../res/alyssa/andrew (14).jpg" width = "300px">
				<img class = "scalePic" src = "../res/alyssa/andrew (15).jpg" width = "300px">
				<img class = "scalePic" src = "../res/alyssa/andrew (16).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/alyssa/andrew (17).jpg" width = "300px">
				<img class = "scalePic" src = "../res/alyssa/andrew (18).jpg" width = "300px">
				<img class = "scalePic" src = "../res/alyssa/andrew (19).jpg" width = "300px">
				<img class = "scalePic" src = "../res/alyssa/andrew (20).jpg" width = "300px">
	...
	<div class = "download">
        <a href = "../res/alyssaZip" class = "downloadLink" download>Download these photos!</a>
    </div>
	</br>
