...
<body>
    <section>
        ...
        <h2 class = "galleryHead">Sara and Greg</h2>
        <section id = "photoStream">
        <div class = "row">
            <div class = "column">
                <img class = "scalePic" src = "../res/sarah/greg (1).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (2).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (3).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (4).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (5).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/sarah/greg (6).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (7).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (8).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (9).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (10).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/sarah/greg (11).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (12).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (13).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (14).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (15).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (16).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/sarah/greg (17).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (18).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (19).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (20).jpg" width = "300px">
				<img class = "scalePic" src = "../res/sarah/greg (21).jpg" width = "300px">
            </div>
	...
	<div class = "download">
        <a href = "../res/saraZip" class = "downloadLink" download>Download these photos!</a>
    </div>
	</br>
