...
<body>
    <section>
        ...
        <h2 class = "galleryHead">Brooke and Collin</h2>
        <section id = "photoStream">
        <div class = "row">
            <div class = "column">
                <img class = "scalePic" src = "../res/brooke/collin (1).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (2).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (3).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (4).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (5).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/brooke/collin (6).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (7).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (8).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (9).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (10).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/brooke/collin (11).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (12).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (13).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (14).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (15).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (16).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/brooke/collin (17).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (18).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (19).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (20).jpg" width = "300px">
				<img class = "scalePic" src = "../res/brooke/collin (21).jpg" width = "300px">
            </div>
	...
	<div class = "download">
        <a href = "../res/brookeZip" class = "downloadLink" download>Download these photos!</a>
    </div>
	</br>
