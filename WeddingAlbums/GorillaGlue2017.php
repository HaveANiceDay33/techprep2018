...
<body>
    <section>
        ...
        <h2 class = "galleryHead">Gorilla Glue 2017</h2>
        <section id = "photoStream">
        <div class = "row">
            <div class = "column">
                <img class = "scalePic" src = "../res/gg/gg (1).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (2).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (3).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (4).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (5).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/gg/gg (6).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (7).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (8).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (9).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (10).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/gg/gg (11).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (12).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (13).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (14).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (15).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (16).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/gg/gg (17).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (18).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (19).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (20).jpg" width = "300px">
				<img class = "scalePic" src = "../res/gg/gg (21).jpg" width = "300px">
            </div>
