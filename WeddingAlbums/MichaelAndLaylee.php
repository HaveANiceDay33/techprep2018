...
<body>
    <section>
        ...
        <h2 class = "galleryHead">Michael And layle</h2>
        <section id = "photoStream">
        <div class = "row">
            <div class = "column">
                <img class = "scalePic" src = "../res/michael/layle (1).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (2).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (3).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (4).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (5).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/michael/layle (6).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (7).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (8).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (9).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (10).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/michael/layle (11).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (12).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (13).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (14).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (15).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (16).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/michael/layle (17).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (18).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (19).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (20).jpg" width = "300px">
				<img class = "scalePic" src = "../res/michael/layle (21).jpg" width = "300px">
            </div>
	...
	<div class = "download">
        <a href = "../res/michaelZip" class = "downloadLink" download>Download these photos!</a>
    </div>
	</br>
