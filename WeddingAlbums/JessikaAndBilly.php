...
<body>
    <section>
        ...
        <h2 class = "galleryHead">Jessika and Billy</h2>
        <section id = "photoStream">
        <div class = "row">
               <div class = "column">
                <img class = "scalePic" src = "../res/jessika/billy (1).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (2).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (3).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (4).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (5).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/jessika/billy (6).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (7).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (8).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (9).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (10).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/jessika/billy (11).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (12).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (13).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (14).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (15).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (16).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/jessika/billy (17).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (18).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (19).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (20).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessika/billy (21).jpg" width = "300px">
            </div>
	...
	<div class = "download">
        <a href = "../res/jessikaZip" class = "downloadLink" download>Download these photos!</a>
    </div>
	</br>
