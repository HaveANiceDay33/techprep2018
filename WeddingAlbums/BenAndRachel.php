...
<body>
    <section>
        ...
        <h2 class = "galleryHead">Ben and Rachel</h2>
        <section id = "photoStream">
        <div class = "row">
            <div class = "column">
                <img class = "scalePic" src = "../res/ben/rachel (1).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (2).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (3).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (4).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (5).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/ben/rachel (6).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (7).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (8).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (9).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (10).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/ben/rachel (11).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (12).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (13).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (14).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (15).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (16).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/ben/rachel (17).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (18).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (19).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (20).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ben/rachel (21).jpg" width = "300px">
            </div>
	...
	<div class = "download">
        <a href = "../res/benZip" class = "downloadLink" download>Download these photos!</a>
    </div>
	</br>
