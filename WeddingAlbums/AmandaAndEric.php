...
<body>
    <section>
        ...
        <h2 class = "galleryHead">Amanda And Eric</h2>
        <section id = "photoStream">
		<div class = "row">
            <div class = "column">
                <img class = "scalePic" src = "../res/amanda/eric (1).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (2).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (3).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (4).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (5).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/amanda/eric (6).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (7).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (8).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (9).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (10).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/amanda/eric (11).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (12).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (13).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (14).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (15).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (16).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/amanda/eric (17).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (18).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (19).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (20).jpg" width = "300px">
				<img class = "scalePic" src = "../res/amanda/eric (21).jpg" width = "300px">
            </div>
	...
	<div class = "download">
        <a href = "../res/amandaZip" class = "downloadLink" download>Download these photos!</a>
    </div>
	</br>
