...
<body>
    <section>
        ...
        <h2 class = "galleryHead">Nichole and Cody</h2>
        <section id = "photoStream">
        <div class = "row">
              <div class = "column">
                <img class = "scalePic" src = "../res/nichole/cody (1).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (2).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (3).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (4).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (5).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/nichole/cody (6).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (7).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (8).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (9).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (10).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/nichole/cody (11).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (12).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (13).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (14).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (15).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (16).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/nichole/cody (17).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (18).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (19).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (20).jpg" width = "300px">
				<img class = "scalePic" src = "../res/nichole/cody (21).jpg" width = "300px">
            </div>
	...
	<div class = "download">
        <a href = "../res/nicholeZip" class = "downloadLink" download>Download these photos!</a>
    </div>
	</br>
