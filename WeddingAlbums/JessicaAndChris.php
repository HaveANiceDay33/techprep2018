...
<body>
    <section>
        ...
        <h2 class = "galleryHead">Jessica and Chris</h2>
        <section id = "photoStream">
        <div class = "row">
            <div class = "column">
                <img class = "scalePic" src = "../res/jessica/chris (1).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (2).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (3).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (4).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (5).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/jessica/chris (6).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (7).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (8).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (9).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (10).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/jessica/chris (11).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (12).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (13).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (14).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (15).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (16).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/jessica/chris (17).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (18).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (19).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (20).jpg" width = "300px">
				<img class = "scalePic" src = "../res/jessica/chris (21).jpg" width = "300px">
            </div>
	...
	<div class = "download">
        <a href = "../res/jessicaZip" class = "downloadLink" download>Download these photos!</a>
    </div>
	</br>
