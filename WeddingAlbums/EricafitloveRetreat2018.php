...
<html>
<head>
    <title>Ericafitlove Retreat 2018</title>
...
<body>
    <section>
        ...
        <h2 class = "galleryHead">EricaFitLove Retreat 2018</h2>
        <section id = "photoStream">
        <div class = "row">
            <div class = "column">
                <img class = "scalePic" src = "../res/ericaFit/erica (1).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (2).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (3).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (4).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (5).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/ericaFit/erica (6).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (7).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (8).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (9).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (10).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/ericaFit/erica (11).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (12).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (13).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (14).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (15).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (16).jpg" width = "300px">
            </div>
             <div class = "column">
               <img class = "scalePic" src = "../res/ericaFit/erica (17).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (18).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (19).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (20).jpg" width = "300px">
				<img class = "scalePic" src = "../res/ericaFit/erica (21).jpg" width = "300px">
            </div>
